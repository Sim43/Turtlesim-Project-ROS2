...
// IWYU pragma: private, include "custom_interfaces/msg/turtle_array.h"


#ifndef CUSTOM_INTERFACES__MSG__DETAIL__TURTLE_ARRAY__FUNCTIONS_H_
#define CUSTOM_INTERFACES__MSG__DETAIL__TURTLE_ARRAY__FUNCTIONS_H_
 ...
 * calls
 * custom_interfaces__msg__TurtleArray__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_interfaces
custom_interfaces__msg__TurtleArray *
custom_interfaces__msg__TurtleArray__create(void);

/// Destroy msg/TurtleArray message.
/**
 * It calls
 * custom_interfaces__msg__TurtleArray__fini()
 ...
 * custom_interfaces__msg__TurtleArray__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * custom_interfaces__msg__TurtleArray__Sequence__fini()
 * on the array,
...
#endif  // CUSTOM_INTERFACES__MSG__DETAIL__TURTLE_ARRAY__FUNCTIONS_H_
