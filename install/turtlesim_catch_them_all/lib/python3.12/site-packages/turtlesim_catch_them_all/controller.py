...
class TurtleControllerNode(Node):
    ...
    def call_catch_turtle_server(self, turtle_name):
        ...
        future.add_done_callback(partial(self.callback_call_catch_turtle_server, turtle_name=turtle_name))
    
    def callback_call_catch_turtle_server(self, future, turtle_name):
        try:
