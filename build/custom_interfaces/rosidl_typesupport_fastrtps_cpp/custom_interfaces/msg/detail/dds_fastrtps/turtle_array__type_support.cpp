...
#include "custom_interfaces/msg/detail/turtle_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const custom_interfaces::msg::Turtle &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  custom_interfaces::msg::Turtle &);
...
cdr_serialize(
  const custom_interfaces::msg::TurtleArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::TurtleArray & ros_message)
{
  // Member: turtles
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Turtle(
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::TurtleArray;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: turtles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        custom_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_Turtle(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::TurtleArray *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, TurtleArray)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_TurtleArray__handle;
}
